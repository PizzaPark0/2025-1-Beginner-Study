...
- 답: Merge - 두 브랜치의 모든 커밋을 Main브랜치에 적용</br>
      Squarsh - 지금까지 있었던 모든 변경사항을 하나의 커밋으로 만들고 Main에 병합</br>
      Rebase - 커밋의 Base를 메인 브랜치로 전환
...
- 답: Commit ID & 현재작업중인 브랜치의 최신 Commit
...
- 답: commit이 삭제되면 자신은 물론 타인의 브랜치에도 영향을 줄 수 있으므로 revert가 바람직하다.
